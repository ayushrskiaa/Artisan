        ...
        <footer className="border-t border-white/10 pt-20 pb-10 mt-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
                    <div className="col-span-1 md:col-span-1">
                        <Link to="/" className="flex items-center space-x-2 mb-6">
                            ...
                            <span className="text-2xl title-font font-bold tracking-wider uppercase">Artisan</span>
                        </Link>
                    ...
                    <div>
                        <h4 className="font-bold mb-6 uppercase text-sm tracking-widest text-accent">Company</h4>
                        <ul className="space-y-4 text-neutral-400">
                ...
                <div className="border-t border-white/5 pt-8 text-center text-neutral-600 text-sm">
                    © 2026 Artisan Gallery Inc. All rights reserved.
                </div>
            </div>
        </footer>
    );
